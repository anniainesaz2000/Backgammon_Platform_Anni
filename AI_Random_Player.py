...
class AI_Random_Player:
    ...
    def validMove(self, makor, yaad, r, my_pieces, other_pieces):
    ...
    def generate_all_moves(self, r, new_board):
        ...
        if self.color == "black" and new_board[27] > 0:  # for black capture pieces
            makor = 25
            yaad = 25 - r
            if self.validMove(makor, yaad, [r], my_pieces, other_pieces):
    ...
    def play(self, board, roll, color, time_left):
